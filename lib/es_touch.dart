...
class EsTouchPage extends StatefulWidget {
  ...
  @override
  _EsTouchPageState createState() => _EsTouchPageState();
}

class _EsTouchPageState extends State<EsTouchPage> {
        ...
        children: <Widget>[
          ...
          Center(
            child: OutlinedButton(
              ...
              child: Text(
                fetchingWifiInfo ? 'Fetching WiFi info' : 'Use from current Wi-Fi',
              ),
            ),
          ),
          TextFormField(
