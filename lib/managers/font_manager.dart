...
class FontManager extends FontsManager {
  ...
  void _prepareFontList() {
    ...
    final gladioraRegular = Font.bySize(fs)
        ..family = 'GladioraRegular'
        ..defaultLanguage = 'en'
        ..defaultUsage = FontUsage.regular
        ..usages = [FontUsage.bold, FontUsage.thin];

    final gladioraLight = Font.bySize(fs)
        ..family = 'GladioraLight'
        ..defaultLanguage = 'en'
        ..defaultUsage = FontUsage.thin
        ..usages = [FontUsage.thin];

    final gladioraBold = Font.bySize(fs)
        ..family = 'GladioraBold'
        ..defaultLanguage = 'en'
    ...
    addFont(iranSans);
    addFont(gladioraRegular);
    addFont(gladioraBold);
    addFont(gladioraLight);
